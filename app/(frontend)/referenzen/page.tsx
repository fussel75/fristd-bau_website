...
// Straßennamen bewusst raus (Datenschutz: keine Kundenadressen im Netz).
// Baujahr bewusst raus (wirkt nach 3 Jahren „alt", ohne Nutzen fuer Interessenten).
// Nur echte Fotos — keine gerenderten Visualisierungen.
const PROJECTS: RefProject[] = [
  ...
  {
    cat: 'Aufstockung',
    title: 'Aufstockung in Holzbauweise',
    loc: 'Hamburg',
    year: '',
  ...
  {
    cat: 'Sanierung',
    title: 'Balkonsanierung mit Bangkirai',
    loc: 'Hamburg',
    year: '',
